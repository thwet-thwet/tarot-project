...
#main App obj callig 
		...
		def _onecard():
			...
			self.img = (Image.open("C:/Users/user/Desktop/projectshow04/tarot_back.jpg"))
			...
			def chooseCard(event):
				...
				try:
					self.imagecard = (Image.open("C:/Users/user/Desktop/projectshow04/Tarot/{}.jpeg".format(self.choosecard_list[x])))
					#self.imagecard = (Image.open("Tarot/{}.jpg".format(self.choosecard_list[x])))
				except Exception:
					self.imagecard = (Image.open("C:/Users/user/Desktop/projectshow04/Tarot/{}.jpg".format(self.choosecard_list[x])))
				...
				self.predict_img = (Image.open("C:/Users/user/Desktop/projectshow04/one/{}.jpg".format(self.choosecard_name)))
...
#=========================================== onecard ==================================================================
		...
		def _past():
			...
			title = tk.Label(self.win,text="Your Past Life",bg=self.bgcolor,fg="cyan")
			...
			def chooseCard(event):
				...
				#self.predict_img = (Image.open("onecard/{}.jpg".format(self.choosecard_list[x])))
				self.predict_img = (Image.open("C:/Users/user/Desktop/projectshow04/past/{}.jpg".format(self.choosecard_name))) #dar bal pyin lite ya bee :-)
...
#=========================================== pastlife ==================================================================
		...
		def _love():
			...
			title = tk.Label(self.win,text="Your Love Life",bg=self.bgcolor,fg="cyan")
			...
			def chooseCard(event):
				...
				#self.predict_img = (Image.open("onecard/{}.jpg".format(self.choosecard_list[x])))
				self.predict_img = (Image.open("C:/Users/user/Desktop/projectshow04/love/{}.jpg".format(self.choosecard_name))) #dar bel pyin lite
...
#=========================================== _love ==================================================================
		...
		def _education():
			...
			title = tk.Label(self.win,text="Your Education Path",bg=self.bgcolor,fg="cyan")
			...
			def chooseCard(event):
				...
				#self.predict_img = (Image.open("onecard/{}.jpg".format(self.choosecard_list[x])))
				self.predict_img = (Image.open("C:/Users/user/Desktop/projectshow04/edu/{}.jpg".format(self.choosecard_name))) #dar bal pyin lite ya bee :-)
...
#=========================================== education ==================================================================
		...
		def _career():
			...
			title = tk.Label(self.win,text="Your Career Path",bg=self.bgcolor,fg="cyan")
			...
			def chooseCard(event):
				...
				#self.predict_img = (Image.open("onecard/{}.jpg".format(self.choosecard_list[x])))
				self.predict_img = (Image.open("C:/Users/user/Desktop/projectshow04/career/{}.jpg".format(self.choosecard_name))) #dar bal pyin lite ya bee :-)
...
#=========================================== career ==================================================================
		...
		def _menu():
			self.bgimg = ImageTk.PhotoImage(Image.open('C:/Users/user/Desktop/projectshow04/tarot.jpg'))
